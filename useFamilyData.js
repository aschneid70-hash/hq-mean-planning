export const MEAL_IDEAS = [
  ...
  { name: "Taco Bowls", tags: ["gluten-free"], time: 30, description: "Rice base, beans for wife, beef for others — everyone customizes", ingredients: ["rice", "ground beef", "black beans", "corn", "cheese", "salsa", "sour cream"] },
...
export const CAT_EMOJIS = {
  ...
  "Pantry & Dry Goods": "🫙", "Sauces & Condiments": "🧴",
  "Spices & Seasonings": "🧂", "Canned & Packaged": "🥫",
  "Frozen": "🧊", "Bakery": "🍞", "Deli": "🧀", "Beverages": "🥤",
...
export const MANUAL_CATEGORIES = [
  ...
  "Sauces & Condiments","Spices & Seasonings","Canned & Packaged","Other"
]
